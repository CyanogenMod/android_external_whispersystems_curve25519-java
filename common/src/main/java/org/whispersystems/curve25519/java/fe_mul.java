...
public static void fe_mul(int[] h,int[] f,int[] g)
{
  ...
  long h0 = (f0 * (long) g0)+(f1_2 * (long) g9_19)+f2g8_19+f3g7_38+f4g6_19+f5g5_38+f6g4_19+f7g3_38+f8g2_19+f9g1_38;
  long h1 = (f0 * (long) g1)+(f1   * (long) g0)   +f2g9_19+f3g8_19+f4g7_19+f5g6_19+f6g5_19+f7g4_19+f8g3_19+f9g2_19;
  long h2 = (f0 * (long) g2)+(f1_2 * (long) g1)   +f2g0   +f3g9_38+f4g8_19+f5g7_38+f6g6_19+f7g5_38+f8g4_19+f9g3_38;
  long h3 = (f0 * (long) g3)+(f1   * (long) g2)   +f2g1   +f3g0   +f4g9_19+f5g8_19+f6g7_19+f7g6_19+f8g5_19+f9g4_19;
  long h4 = (f0 * (long) g4)+(f1_2 * (long) g3)   +f2g2   +f3g1_2 +f4g0   +f5g9_38+f6g8_19+f7g7_38+f8g6_19+f9g5_38;
  long h5 = (f0 * (long) g5)+(f1   * (long) g4)   +f2g3   +f3g2   +f4g1   +f5g0   +f6g9_19+f7g8_19+f8g7_19+f9g6_19;
  long h6 = (f0 * (long) g6)+(f1_2 * (long) g5)   +f2g4   +f3g3_2 +f4g2   +f5g1_2 +f6g0   +f7g9_38+f8g8_19+f9g7_38;
  long h7 = (f0 * (long) g7)+(f1   * (long) g6)   +f2g5   +f3g4   +f4g3   +f5g2   +f6g1   +f7g0   +f8g9_19+f9g8_19;
  long h8 = (f0 * (long) g8)+(f1_2 * (long) g7)   +f2g6   +f3g5_2 +f4g4   +f5g3_2 +f6g2   +f7g1_2 +f8g0   +f9g9_38;
  long h9 = (f0 * (long) g9)+(f1   * (long) g8)   +f2g7   +f3g6   +f4g5   +f5g4   +f6g3   +f7g2   +f8g1   +f9g0   ;
  long carry0;
  long carry1;
  long carry2;
  long carry3;
